...
pub(crate) fn run_kernel_decompile_coverage(args: &[String]) -> AppResult<()> {
    ...
    println!(
        "kernel_decompile_coverage root={} files_seen={} files_parsed={} parse_errors={} parsed_instructions={} cfg_blocks={} cfg_edges={} dominator_blocks={} natural_loops={} dataflow_ops={} reaching_uses={} ssa_values={} def_use_edges={} value_ops={} live_ranges={} memory_accesses={} semantic_patterns={} unsupported_instructions={} summary_path={} files_path={} opcode_frequency_path={} opcode_signature_frequency_path={} cfg_blocks_path={} cfg_edges_path={} dominators_path={} natural_loops_path={} dataflow_path={} reaching_uses_path={} ssa_values_path={} def_use_edges_path={} value_ops_path={} live_ranges_path={} memory_accesses_path={} semantic_patterns_path={} semantic_pattern_frequency_path={} unsupported_instructions_path={}",
        report.root.display(),
        report.files.len(),
...
pub(crate) fn run_kernel_decompile_sass(args: &[String]) -> AppResult<()> {
    ...
    println!(
        "kernel_decompile_sass parsed_instructions={} cfg_blocks={} cfg_edges={} dominator_blocks={} natural_loops={} reaching_uses={} ssa_values={} def_use_edges={} value_ops={} live_ranges={} memory_accesses={} semantic_patterns={} unsupported_instructions={} sass_path={} ir_path={} analysis_path={} pattern_path={} side_by_side_path={}",
        report.parsed_instruction_count,
        report.cfg_block_count,
        report.cfg_edge_count,
        report.dominator_block_count,
...
pub(crate) fn run_kernel_decompile_fixtures(args: &[String]) -> AppResult<()> {
    ...
    for report in reports {
        println!(
            "kernel_decompile_fixture fixture={} symbol={} parsed_instructions={} cfg_blocks={} cfg_edges={} dominator_blocks={} natural_loops={} reaching_uses={} ssa_values={} def_use_edges={} value_ops={} live_ranges={} memory_accesses={} semantic_patterns={} unsupported_instructions={} source_path={} ptx_path={} cubin_path={} sass_path={} ir_path={} analysis_path={} pattern_path={} side_by_side_path={}",
            report.fixture.name(),
            report.symbol,
            report.parsed_instruction_count,
            report.cfg_block_count,
