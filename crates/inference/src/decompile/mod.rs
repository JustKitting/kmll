...
pub use self::{
    analysis::{
        ...
        SassCfgEdgeKind, SassDataflowOp, SassDominatorBlock, SassLiveRange, SassMemoryAccess,
        SassMemoryAccessKind, SassNaturalLoop, SassReachingUse, analyze_sass_ir,
    },
    coverage::{
        ...
        SassCoverageMemoryAccess, SassCoverageNaturalLoop, SassCoverageOptions,
