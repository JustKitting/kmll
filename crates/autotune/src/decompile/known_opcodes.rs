...
impl From<SassLiftedOpKind> for SassOpcodeCatalogKind {
    fn from(kind: SassLiftedOpKind) -> Self {
        match kind {
            ...
            SassLiftedOpKind::NumericConvert => Self::NumericConvert,
            ...
            SassLiftedOpKind::Select => Self::Select,
...
const KNOWN_SASS_OPCODES: &[KnownSassOpcode] = &[
    ...
    local!(Vote, Warp, WarpElect),
    local!(Voteu, Warp, WarpElect),
