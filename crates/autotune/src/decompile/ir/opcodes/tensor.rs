...
fn modifier_tensor_element_type(modifier: &SassModifierKind) -> Option<SassTensorElementType> {
    match modifier {
        ...
        SassModifierKind::Fp6 => Some(SassTensorElementType::Fp6),
        SassModifierKind::E2M3 => Some(SassTensorElementType::E2M3),
        SassModifierKind::E3M2 => Some(SassTensorElementType::E3M2),
